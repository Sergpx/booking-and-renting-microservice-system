...
import org.sergp.paymentservice.dto.Violation;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(UnknownWebHookException.class)
    public ResponseEntity<?> handleUnknownWebHookException(UnknownWebHookException ex, WebRequest request) {
        logError(ex, request);
